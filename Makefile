...
#OBJECTS += main.o
#OBJECTS += HAL_testMain.o
OBJECTS += endnode_main.o
#OBJECTS += gateway_main.o
OBJECTS += Rx_HAL.o
OBJECTS += Rx_HHI.o
OBJECTS += Tx_HAL.o
OBJECTS += Tx_HHI.o
OBJECTS += Common_HAL.o
OBJECTS += Common_HHI.o
OBJECTS += HAL_FSM.o
OBJECTS += LoRa_PHY_FSM.o
#OBJECTS += LoRa_RMAC_FSM.o
...
CXX_FLAGS += -DBOARDVARIANT_SX1272
#CXX_FLAGS+= -DRMAC_ON
CXX_FLAGS+= -DPHY_ONLY
CXX_FLAGS+= -DANALYSIS_ON
